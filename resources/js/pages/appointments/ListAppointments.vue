          ...
          <div class="d-flex justify-content-between mb-2">
            ...
            <div class="btn-group">
              <button
                ...
                class="btn"
                :class="[
                  typeof selectedStatus === 'undefined' ? 'btn-secondary' : 'btn-default',
                ]"
              >
              ...
              <button
                ...
                class="btn"
                :class="[
                  selectedStatus === status.value ? 'btn-secondary' : 'btn-default',
                ]"
              >
                <span class="mr-1">{{ status.name.toUpperCase() }}</span>
