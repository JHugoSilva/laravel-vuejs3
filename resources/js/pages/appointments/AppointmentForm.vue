...
const getAppointment = () => {
    ...
    .then(({data}) => {
        ...
        form.clients_id = data.clients_id
                        ...
                        <div class="card-body">
                            <Form @submit="handleSubmit" v-slot:default="{ errors }">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select v-model="form.clients_id" id="client_id" :class="{'is-invalid':errors.clients_id}" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="form.start_time" class="form-control flatpickr" :class="{'is-invalid':errors.start_time}" id="start-time">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="form.end_time" class="form-control flatpickr" :class="{'is-invalid':errors.end_time}" id="end-time">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" :class="{'is-invalid':errors.description}" v-model="form.description" id="description" rows="3"
